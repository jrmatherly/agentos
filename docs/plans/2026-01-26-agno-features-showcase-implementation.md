# Agno Features Showcase Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add comprehensive examples across 6 Agno feature categories for learning/reference purposes.

**Architecture:** Organize new agents by feature category in subdirectories (`agents/reasoning/`, `agents/tools/`, etc.). Create new top-level `teams/` and `workflows/` directories. Each component follows existing patterns from `knowledge_agent.py`.

**Tech Stack:** Agno framework, LiteLLM, PostgreSQL/pgvector, YFinance, Newspaper4k, ReasoningTools
...
```python
# In pyproject.toml, add these to the dependencies list after "fastmcp":
  "yfinance>=0.2.0",
  "newspaper4k>=0.9.0",
...
Expected: requirements.txt updated with new packages
...
git commit -m "chore: add yfinance, newspaper4k dependencies for new agents"
```
...
- Create: `agents/reasoning/__init__.py`
- Create: `agents/tools/__init__.py`
- Create: `agents/learning/__init__.py`
- Create: `agents/hitl/__init__.py`
- Create: `teams/__init__.py`
- Create: `workflows/__init__.py`

**Step 1: Create agent subdirectories with empty **init**.py**

```bash
mkdir -p agents/reasoning agents/tools agents/learning agents/hitl teams workflows
touch agents/reasoning/__init__.py agents/tools/__init__.py agents/learning/__init__.py agents/hitl/__init__.py
touch teams/__init__.py workflows/__init__.py
```

**Step 2: Verify directories exist**

Run: `ls -la agents/ teams/ workflows/`
Expected: All directories created with **init**.py files

**Step 3: Commit**

```bash
git add agents/reasoning agents/tools agents/learning agents/hitl teams workflows
git commit -m "chore: create directory structure for feature showcase"
```

---

## Task 3: Move research_team.py to teams/

**Files:**

- Move: `agents/research_team.py` → `teams/research_team.py`
- Modify: `teams/__init__.py`

**Step 1: Move the file**

```bash
git mv agents/research_team.py teams/research_team.py
```

**Step 2: Update teams/**init**.py**

```python
from .research_team import research_team

__all__ = ["research_team"]
```

**Step 3: Verify import works**

Run: `python -c "from teams import research_team; print(research_team.name)"`
Expected: "Research Team"

**Step 4: Commit**

```bash
git add teams/
git commit -m "refactor: move research_team to teams/ directory"
```

---

## Task 4: Move content_workflow.py to workflows/

**Files:**

- Move: `agents/content_workflow.py` → `workflows/content_workflow.py`
- Modify: `workflows/__init__.py`

**Step 1: Move the file**

```bash
git mv agents/content_workflow.py workflows/content_workflow.py
```

**Step 2: Update workflows/**init**.py**

```python
from .content_workflow import content_workflow

__all__ = ["content_workflow"]
```

**Step 3: Verify import works**

Run: `python -c "from workflows import content_workflow; print(content_workflow.name)"`
...
```bash
git add workflows/
git commit -m "refactor: move content_workflow to workflows/ directory"
```

---

## Task 5: Update app/main.py Imports (Phase 1)

**Files:**

- Modify: `app/main.py:22-25`

**Step 1: Update imports for moved files**

Change:

```python
from agents.content_workflow import content_workflow  # noqa: E402
from agents.research_team import research_team  # noqa: E402
```

To:

```python
from teams.research_team import research_team  # noqa: E402
from workflows.content_workflow import content_workflow  # noqa: E402
```
...
```bash
git add app/main.py
git commit -m "refactor: update imports for moved team and workflow"
```

---

## Task 6: Create Finance Agent

**Files:**

- Create: `agents/tools/finance_agent.py`
- Modify: `agents/tools/__init__.py`

**Step 1: Create finance_agent.py**
...
**Step 2: Update agents/tools/**init**.py**
...
Run: `python -c "from agents.tools import finance_agent; print(finance_agent.name)"`
Expected: "Finance Agent"

**Step 4: Commit**

```bash
git add agents/tools/
git commit -m "feat: add finance agent with YFinance tools"
```

---

## Task 7: Create Web Scraper Agent

**Files:**

- Create: `agents/tools/web_scraper_agent.py`
- Modify: `agents/tools/__init__.py`

**Step 1: Create web_scraper_agent.py**
...
__all__ = ["finance_agent", "web_scraper_agent"]
```

**Step 3: Verify import works**

Run: `python -c "from agents.tools import web_scraper_agent; print(web_scraper_agent.name)"`
Expected: "Web Scraper Agent"

**Step 4: Commit**

```bash
git add agents/tools/
git commit -m "feat: add web scraper agent with Newspaper4k tools"
```

---

## Task 8: Create Research Agent

**Files:**

- Create: `agents/tools/research_agent.py`
- Modify: `agents/tools/__init__.py`
...
__all__ = ["finance_agent", "web_scraper_agent", "research_agent"]
```

**Step 3: Verify import works**

Run: `python -c "from agents.tools import research_agent; print(research_agent.name)"`
...
```bash
git add agents/tools/
git commit -m "feat: add research agent with deep research capabilities"
```

---

## Task 9: Create Reasoning Model Agent

**Files:**

- Create: `agents/reasoning/reasoning_model_agent.py`
- Modify: `agents/reasoning/__init__.py`

**Step 1: Create reasoning_model_agent.py**
...
**Step 2: Update agents/reasoning/**init**.py**

```python
from .reasoning_model_agent import reasoning_model_agent

__all__ = ["reasoning_model_agent"]
```

**Step 3: Verify import works**

Run: `python -c "from agents.reasoning import reasoning_model_agent; print(reasoning_model_agent.name)"`
Expected: "Reasoning Model Agent"

**Step 4: Commit**

```bash
git add agents/reasoning/
git commit -m "feat: add reasoning model agent demonstrating native reasoning"
```

---

## Task 10: Create Reasoning Tools Agent

**Files:**

- Create: `agents/reasoning/reasoning_tools_agent.py`
- Modify: `agents/reasoning/__init__.py`

**Step 1: Create reasoning_tools_agent.py**
...
__all__ = ["reasoning_model_agent", "reasoning_tools_agent"]
```

**Step 3: Verify import works**

Run: `python -c "from agents.reasoning import reasoning_tools_agent; print(reasoning_tools_agent.name)"`
Expected: "Reasoning Tools Agent"

**Step 4: Commit**

```bash
git add agents/reasoning/
git commit -m "feat: add reasoning tools agent with ReasoningTools"
```

---

## Task 11: Create Reasoning Agent (reasoning=True)

**Files:**

- Create: `agents/reasoning/reasoning_agent.py`
- Modify: `agents/reasoning/__init__.py`

**Step 1: Create reasoning_agent.py**
...
Run: `python -c "from agents.reasoning import reasoning_agent; print(reasoning_agent.name)"`
Expected: "Reasoning Agent"

**Step 4: Commit**

```bash
git add agents/reasoning/
git commit -m "feat: add reasoning agent with reasoning=True flag"
```

---

## Task 12: Create Learning Assistant

**Files:**

- Create: `agents/learning/learning_assistant.py`
- Modify: `agents/learning/__init__.py`

**Step 1: Create learning_assistant.py**
...
**Step 2: Update agents/learning/**init**.py**
...
Run: `python -c "from agents.learning import learning_assistant; print(learning_assistant.name)"`
Expected: "Learning Assistant"

**Step 4: Commit**

```bash
git add agents/learning/
git commit -m "feat: add learning assistant with agentic learning mode"
```

---

## Task 13: Create Confirmation Agent (HITL)

**Files:**

- Create: `agents/hitl/confirmation_agent.py`
- Modify: `agents/hitl/__init__.py`

**Step 1: Create confirmation_agent.py**
...
# ============================================================================
# Custom Toolkit with Confirmation Tools
# ============================================================================
class ConfirmationToolkit(Toolkit):
    """Toolkit demonstrating HITL confirmation patterns."""

    def __init__(self):
        super().__init__(name="confirmation_tools")
        self.register(self.send_email, requires_confirmation=True)
        self.register(self.delete_file, requires_confirmation=True)
        self.register(self.execute_command, requires_confirmation=True)
...
if __name__ == "__main__":
    ...
    if hasattr(response, "active_requirements"):
...
**Step 2: Update agents/hitl/**init**.py**

```python
from .confirmation_agent import confirmation_agent

__all__ = ["confirmation_agent"]
```

**Step 3: Verify import works**

Run: `python -c "from agents.hitl import confirmation_agent; print(confirmation_agent.name)"`
Expected: "Confirmation Agent"

**Step 4: Commit**

```bash
git add agents/hitl/
git commit -m "feat: add confirmation agent with HITL patterns"
```

---

## Task 14: Create Support Team

**Files:**

- Create: `teams/support_team.py`
- Modify: `teams/__init__.py`

**Step 1: Create support_team.py**
...
```python
from .research_team import research_team
from .support_team import support_team

__all__ = ["research_team", "support_team"]
```

**Step 3: Verify import works**

Run: `python -c "from teams import support_team; print(support_team.name)"`
Expected: "Support Team"

**Step 4: Commit**

```bash
git add teams/
git commit -m "feat: add support team with intelligent routing"
```

---

## Task 15: Create Reasoning Team

**Files:**

- Create: `teams/reasoning_team.py`
- Modify: `teams/__init__.py`

**Step 1: Create reasoning_team.py**
...
```python
from .reasoning_team import reasoning_team
from .research_team import research_team
from .support_team import support_team

__all__ = ["research_team", "support_team", "reasoning_team"]
```

**Step 3: Verify import works**

Run: `python -c "from teams import reasoning_team; print(reasoning_team.name)"`
Expected: "Reasoning Team"

**Step 4: Commit**

```bash
git add teams/
git commit -m "feat: add reasoning team with visible thinking process"
```

---

## Task 16: Create Blog Generator Workflow

**Files:**

- Create: `workflows/blog_generator.py`
- Modify: `workflows/__init__.py`

**Step 1: Create blog_generator.py**
...
```python
from .blog_generator import blog_workflow
from .content_workflow import content_workflow

__all__ = ["content_workflow", "blog_workflow"]
```

**Step 3: Verify import works**

Run: `python -c "from workflows import blog_workflow; print(blog_workflow.name)"`
Expected: "Blog Generator"

**Step 4: Commit**

```bash
git add workflows/
git commit -m "feat: add blog generator workflow with async and caching"
```

---

## Task 17: Update app/main.py (Final Integration)

**Files:**

- Modify: `app/main.py`

**Step 1: Update all imports and registrations**
...
**Step 2: Verify app imports successfully**
...
```bash
git add app/main.py
git commit -m "feat: register all new agents, teams, and workflows"
```

---

## Task 18: Update agents/**init**.py
...
Run: `python -c "from agents import finance_agent, reasoning_agent; print('OK')"`
Expected: "OK"
...
git commit -m "chore: update agents __init__.py with all exports"
```

---

## Task 19: Run Format and Validate
...
```bash
git add -A
git commit -m "style: format all new files" --allow-empty
```
...
**Step 1: Add new agents to CLAUDE.md**
...
|-------|---------|-------|----------|
| `knowledge_agent` | Vector search Q&A | gpt-5-mini | Hybrid search, agentic memory, PII guardrail |
| `mcp_agent` | Tool-based Q&A | gpt-5-mini | MCP tools, agentic memory, PII guardrail |
| `reasoning/reasoning_model_agent` | Native reasoning | configurable | Chain-of-thought, agentic memory |
| `reasoning/reasoning_tools_agent` | Explicit reasoning | configurable | ReasoningTools, think/analyze |
| `reasoning/reasoning_agent` | Structured CoT | configurable | reasoning=True flag |
| `tools/finance_agent` | Financial analysis | configurable | YFinance tools |
| `tools/web_scraper_agent` | Web extraction | configurable | DuckDuckGo, Newspaper4k |
| `tools/research_agent` | Deep research | configurable | Multi-source reports |
| `learning/learning_assistant` | Adaptive assistant | configurable | Learning Machine, agentic mode |
| `hitl/confirmation_agent` | HITL patterns | configurable | User confirmation flows |
```
...
|----------|---------|-------|
| `content_workflow` | Content creation | researcher → writer → editor |
| `blog_generator` | Blog posts with caching | research → scrape → write (async) |
```
...
```bash
git add CLAUDE.md
git commit -m "docs: update CLAUDE.md with new agents, teams, workflows"
```
...
Run: `docker compose up -d agentos-db`
Expected: Database running

**Step 2: Test the application starts**

Run: `timeout 10 python -m app.main || true`
Expected: Server starts without import errors (will timeout, that's OK)
...
| 2 | Create directory structure | 6 **init**.py files |
| 3 | Move research_team | agents/ → teams/ |
| 4 | Move content_workflow | agents/ → workflows/ |
| 5 | Update imports (phase 1) | app/main.py |
| 6 | Finance agent | agents/tools/finance_agent.py |
| 7 | Web scraper agent | agents/tools/web_scraper_agent.py |
| 8 | Research agent | agents/tools/research_agent.py |
| 9 | Reasoning model agent | agents/reasoning/reasoning_model_agent.py |
| 10 | Reasoning tools agent | agents/reasoning/reasoning_tools_agent.py |
| 11 | Reasoning agent | agents/reasoning/reasoning_agent.py |
| 12 | Learning assistant | agents/learning/learning_assistant.py |
| 13 | Confirmation agent | agents/hitl/confirmation_agent.py |
| 14 | Support team | teams/support_team.py |
| 15 | Reasoning team | teams/reasoning_team.py |
| 16 | Blog generator workflow | workflows/blog_generator.py |
| 17 | Final app/main.py | app/main.py |
| 18 | Update agents/**init**.py | agents/**init**.py |
| 19 | Format and validate | All files |
| 20 | Update documentation | CLAUDE.md |
| 21 | Final verification | N/A |
